...
contract SimulateComplete is Script {
    ...
    function run() external {
        ...
        console.log("  Premium收入: 800 USDT (from users)");
        console.log("  Strike收入: 16,000 USDT (8 options exercised)");
        console.log("  ETH返还: 2 ETH (unexercised options)");
        console.log("  Net: -8 ETH, +16,800 USDT");
        console.log("");
        console.log("USER1:");
        console.log("  Premium支出: 500 USDT");
        console.log("  Strike支出: 10,000 USDT");
        console.log("  ETH获得: 5 ETH");
        console.log("  Net: +5 ETH, -10,500 USDT");
        console.log("");
        console.log("USER2:");
        console.log("  Premium支出: 300 USDT");
        console.log("  Strike支出: 6,000 USDT");
        console.log("  ETH获得: 3 ETH");
